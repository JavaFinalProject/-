...
public class DoubanTest {
	public static ArrayList<String> douban() throws IOException {
      ...
      String s2 = "&filter=";
        ...
        PrintStream ps = new PrintStream("D:\\douban2.txt");//打印流
	...
	public static void main(String[] args) throws Exception {
			...
			DoubanTest doubantest=new DoubanTest();
			int size=doubantest.douban().size();
			//String array[]=new String[250];
			//for(int i=0;i<250;i++) {
			//	array[i]=(String)doubantest.douban().get(i);
			//}
			String[]array=(String[])doubantest.douban().toArray(new String[size]);
